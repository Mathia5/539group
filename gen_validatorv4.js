...
var ph=obj.children[1].children[1].children[1].value;
var em1=obj.children[1].children[2].children[1].value;
var em2=obj.children[1].children[3].children[1].value;
var pw1=obj.children[1].children[4].children[1].value;
...
{
	obj.children[1].children[0].children[2].innerHTML="&nbsp&nbsp&nbsp&nbsp Invalid name";
	JudgeDetail[0]=0;
}else
{
    JudgeDetail[0]=1;
...
{
	obj.children[1].children[1].children[2].innerHTML="&nbsp&nbsp&nbsp&nbsp Invalid number";
	JudgeDetail[1]=0;
}else
{
	JudgeDetail[1]=1;
...
{
	obj.children[1].children[2].children[2].innerHTML="&nbsp&nbsp&nbsp&nbsp Invalid email";
	JudgeDetail[2]=0;
}else
{
	JudgeDetail[2]=1;
...
{
	obj.children[1].children[3].children[2].innerHTML="&nbsp&nbsp&nbsp&nbsp email doesn't match";
	JudgeDetail[3]=0;
}else
{
	JudgeDetail[3]=1;
