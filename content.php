                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <p>Here are some tips you can use to reach busy contacts though email: keep it short, format for readability and clarity,
                                        make it clear what you want them to do, be reasonable with your request, and show them why you’re worth their time.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="box">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p>Of course xperience and ability are important, but there are many other critical skills that make you a qualified candidate. This
                                    article provides a look at those other skills that companies like Google are looking for when hiring.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <p>Writing an effective cover letter can be challenging, but putting the time in to create that perfect cover letter can really make or break your
                                    ability to land an interview. This article explore how you can use the cover letter to give yourself that extra edge.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>We often don't think of our body language as communicating to ourselves, but as Amy Cuddy shows in this TED talk, improving our
                                body language can greatly improve the way in which we carry ourselves and perform under pressure.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>Everyone performs some kind of mental preparation before walking into an interview. This articles provies a list of ten effective psychological
                                techniques that can help you deliver the interview performance of a lifetime.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>Here are three key principles from the article: find out as much as you can about the job qualifications ahead of time, prepare concise
                                stories that demonstrate your ability to do the job, rehearse the first 30 seconds of the interview.</p>
                        </div>
                    </div>
                </div>
            </div>
